...
const Sidebar = ({ onTabChange }) => {
  ...
  return (
    <div className="sidebar">
      ...
      <div className="top-section">
        <div className="logo">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-rocket-fill" viewBox="0 0 16 16">
  ...
  <path d="M8 14.5c.5 0 .999-.046 1.479-.139L8.4 15.8a.5.5 0 0 1-.8 0l-1.079-1.439c.48.093.98.139 1.479.139"/>
      ...
      <div className="center-section">
        <button
          onClick={() => { onTabChange("home"); setActiveTab("home"); }}
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-layers" viewBox="0 0 16 16">
            <path d="M8.235 1.559a.5.5 0 0 0-.47 0l-7.5 4a.5.5 0 0 0 0 .882L3.188 8 .264 9.559a.5.5 0 0 0 0 .882l7.5 4a.5.5 0 0 0 .47 0l7.5-4a.5.5 0 0 0 0-.882L12.813 8l2.922-1.559a.5.5 0 0 0 0-.882zm3.515 7.008L14.438 10 8 13.433 1.562 10 4.25 8.567l3.515 1.874a.5.5 0 0 0 .47 0zM8 9.433 1.562 6 8 2.567 14.438 6z" />
          </svg> Projects
        </button>
        <button
          onClick={() => { onTabChange("yourProjects"); setActiveTab("yourProjects"); }}
          className={activeTab === "yourProjects" ? "active" : ""}
        >
      ...
      <div className="bottom-section">
        <button
          onClick={() => { onTabChange("account"); setActiveTab("account"); }}
        ...
        <button
          onClick={() => { onTabChange("settings"); setActiveTab("settings"); }}
        ...
        <button
          onClick={() => { onTabChange("logout"); setActiveTab("logout"); }}
